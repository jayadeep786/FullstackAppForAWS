pipeline {
    ...
    environment {
        ...
        TOMCAT_URL = 'http://35.172.213.19:9090/manager/text'
        TOMCAT_USER = 'admin'
        TOMCAT_PASS = 'admin'
    ...
    stages {
        stage('Clone Repository') {
            steps {
                git url: 'https://github.com/jayadeep786/FullstackAppForAWS.git', branch: 'main'
            }
        }
    ...
    post {
        success {
            echo "✅ Backend deployed: http://35.172.213.19:9090/springapp1"
            echo "✅ Frontend deployed: http://35.172.213.19:9090/frontapp1"
        }
        failure {
